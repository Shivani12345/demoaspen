...
export const checkCreditCard = (cardnumber: string | number | any) => {
  ...
  const cards = [];
  cards[0] = {id: 6,name: 'Visa', length: '13,16', prefixes: '4', checkdigit: true};
  cards[1] = {
    id:5,
    name: 'MasterCard',
    length: '16',
  ...
  cards[4] = {id: 7,name: 'AmEx', length: '15', prefixes: '34,37', checkdigit: true};
  cards[5] = {
    id:8,
    name: 'Discover',
    length: '16',
  ...
  for (let i = 0; i < cards.length; i++) {
    ...
    if (lengthValid && prefixValid) {
      ...
      cardTypeId = cards[i].id;
      return response(true, null, cardCompany,cardTypeId);
    }
  }
